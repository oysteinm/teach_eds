...
![The above image, used during a department presentation in December 2024, shows my teaching evolution: in 2014, I enthusiastically captured a "talk and chalk" lecture full of equations, pleased with how it went, while in 2024, we emphasize practical skills by teaching students Python to connect theory with application.](talk_and_chalk.png)
...
plot1 <- 
  ...
  geom_vline(xintercept = 2017, linetype = "dashed", color = "red", lwd = 2) +
  labs(title = "Sum of grades C and B in Econometrics for Business students",
       x = " ",
       y = "Percentile Sum of grades C and D") +
  theme_minimal()
```
